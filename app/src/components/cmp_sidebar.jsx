...
import homeIcon from "../assets/images/img_home.svg";
import analysisIcon from "../assets/images/img_analysis.svg";
import addExpenseIcon from "../assets/images/img_report.svg";
import barsImage from "../assets/images/img_bars.svg";
  ...
  return (
    <div className="w-20 h-screen bg-self-finance-green flex flex-col items-center fixed left-0 top-0 shadow-lg">
      ...
      <div className="flex flex-col items-center justify-around flex-1 py-5">
        ...
        {/* Home Button */}
        <NavLink to="/home" className="no-underline text-inherit flex items-center justify-center w-12 h-12 rounded-lg transition-colors duration-200 hover:bg-white/20" end>
      ...
      {/* Bars Button */}
      <NavLink to="/report" className="no-underline text-inherit flex items-center justify-center w-12 h-12 rounded-lg transition-colors duration-200 hover:bg-white/20">
